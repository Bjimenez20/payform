                ...
                <div class="card shadow-lg">
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-end mb-3">
                            <a href="{{ route('login') }}" class="btn btn-lg btn-primary rounded-5">Ver pago</a>
                        </div>
                        <form id="payments">
                            <div class="col mb-4">
                                <div class="row">
                            ...
                            <div class="col mb-4">
                                <div class="row">
                                    ...
                                    <div class="col d-none" id="option_reference_id_pse_portals">
                                        <label for="" class="fw-bold mb-2">ID DE REFERENCIAID de Referencia <span
                                                class="text-danger fw-bold">*</span></label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" name="account_bank" id="account_bank"
                                                class="form-control" data-title="Banco de la Cuenta">
                                        </div>
                                    </div>
                                </div>
                                <div class="col mb-4">
                                    <div class="row">
                                        <div class="col">
                                            <label for="" class="fw-bold mb-2">Cédula de quien recibe <span
                                                    class="text-danger fw-bold">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input type="text" name="airline_link" id="airline_link"
                                                class="form-control" data-title="Link Aerolínea">
                                        </div>
                                        <div class="col">
                                            ...
                                            <select name="flight_type" id="flight_type" class="form-control"
                                                ...
                                                @foreach ($type_filghts as $type_filght)
                                                    <option value="{{ $type_filght->id }}">{{ $type_filght->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col mb-4 d-none" id="vuelo_ida">
                                    <div class="card-header bg-primary text-white text-center">
                                        <h4 class="d-flex justify-content-center">Datos vuelo ida</h4>
                                    </div>
                                    <div class="col mb-4">
                                        <div class="row">
                                            <div class="col">
                                ...
                                <div class="col mb-4 d-none" id="vuelo_vuelta">
                                    <div class="card-header bg-primary text-white text-center">
                                        <h4 class="d-flex justify-content-center">Datos vuelo vuelta</h4>
                                    </div>
                                    <div class="col mb-4">
                                        <div class="row">
                                            <div class="col">
                            ...
                            <div class="col my-5 d-flex justify-content-center">
                                <button type="button" class="btn btn-lg btn-primary  rounded-5"
